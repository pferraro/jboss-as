 ...
 * @author Paul Ferraro
 */
public class CacheRegistryTestCase extends RegistryTestCase {

    private static final String MODULE_NAME = "cache-registry";
    ...
    private static Archive<?> createDeployment() {
        ...
        jar.addAsManifestResource(CacheRegistryTestCase.class.getPackage(), "ejb-jar-cache.xml", "ejb-jar.xml");
        return jar;
    }

    public CacheRegistryTestCase() {
        super(MODULE_NAME);
    }
}
