...
import org.jboss.as.test.clustering.cluster.singleton.service.ChannelNodeServiceActivator;
 ...
 * @author Paul Ferraro
 */
public class ChannelSingletonServiceTestCase extends SingletonServiceTestCase {
    ...
    private static Archive<?> createDeployment() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "group-singleton.war");
        ...
        war.addAsServiceProvider(org.jboss.msc.service.ServiceActivator.class, ChannelNodeServiceActivator.class);
        return war;
    }
}
