...
import org.jboss.as.test.clustering.cluster.singleton.service.CacheNodeServiceActivator;
 ...
 * @author Paul Ferraro
 */
public class LocalCacheSingletonServiceTestCase extends SingletonServiceTestCase {

    @Deployment
    public static Archive<?> deployment() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "local-cache-singleton.war");
        ...
        war.addAsServiceProvider(org.jboss.msc.service.ServiceActivator.class, CacheNodeServiceActivator.class);
        return war;
    }
}
