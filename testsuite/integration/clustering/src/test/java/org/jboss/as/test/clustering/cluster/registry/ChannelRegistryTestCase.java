 ...
 * @author Paul Ferraro
 */
public class ChannelRegistryTestCase extends RegistryTestCase {

    private static final String MODULE_NAME = "channel-registry";
    ...
    private static Archive<?> createDeployment() {
        ...
        jar.addAsManifestResource(ChannelRegistryTestCase.class.getPackage(), "ejb-jar-channel.xml", "ejb-jar.xml");
        return jar;
    }

    public ChannelRegistryTestCase() {
        super(MODULE_NAME);
    }
}
