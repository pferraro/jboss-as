...
public enum MathMarshallerProvider implements ProtoStreamMarshallerProvider {
    ...
    BIG_INTEGER(new FunctionalScalarMarshaller<>(Scalar.BYTE_ARRAY.cast(byte[].class), Functions.constantSupplier(BigInteger.ZERO), BigInteger::toByteArray, BigInteger::new)),
