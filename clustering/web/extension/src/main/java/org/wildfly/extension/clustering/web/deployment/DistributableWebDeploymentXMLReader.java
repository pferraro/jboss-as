...
public class DistributableWebDeploymentXMLReader implements XMLElementReader<MutableDistributableDeploymentConfiguration>, JBossAllXMLParser<DistributableWebDeploymentConfiguration> {
    ...
    public void readElement(XMLExtendedStreamReader reader, MutableDistributableDeploymentConfiguration configuration) throws XMLStreamException {
        ...
        switch (reader.getLocalName()) {
            ...
            case INFINISPAN_SESSION_MANAGEMENT: {
                ...
                RouteLocatorServiceConfiguratorFactory<InfinispanSessionManagementConfiguration<Module>> factory = this.readInfinispanSessionManagement(reader, config, configuration);
    ...
    private RouteLocatorServiceConfiguratorFactory<InfinispanSessionManagementConfiguration<Module>> readInfinispanSessionManagement(XMLExtendedStreamReader reader, MutableInfinispanSessionManagementConfiguration configuration, Consumer<String> accumulator) throws XMLStreamException {
        ...
        RouteLocatorServiceConfiguratorFactory<InfinispanSessionManagementConfiguration<Module>> affinityFactory = this.readInfinispanAffinity(reader);
    ...
    private RouteLocatorServiceConfiguratorFactory<InfinispanSessionManagementConfiguration<Module>> readInfinispanAffinity(XMLExtendedStreamReader reader) throws XMLStreamException {
        if (!reader.hasNext() || reader.nextTag() == XMLStreamConstants.END_ELEMENT) {
    ...
    private RouteLocatorServiceConfiguratorFactory<DistributableSessionManagementConfiguration<Module>> readHotRodSessionManagement(XMLExtendedStreamReader reader, MutableHotRodSessionManagementConfiguration configuration) throws XMLStreamException {
