 ...
 * @author Paul Ferraro
 */
public class HotRodSessionManagerFactoryServiceConfigurator<S, SC, AL, LC>  extends SimpleServiceNameProvider implements CapabilityServiceConfigurator, HotRodSessionManagerFactoryConfiguration<Module, S, SC, AL, LC>, Supplier<SessionManagerFactory<SC, LC, TransactionBatch>> {
    ...
    public HotRodSessionManagerFactoryServiceConfigurator(HotRodSessionManagementConfiguration<Module> configuration, SessionManagerFactoryConfiguration<S, SC, AL, LC> factoryConfiguration) {
