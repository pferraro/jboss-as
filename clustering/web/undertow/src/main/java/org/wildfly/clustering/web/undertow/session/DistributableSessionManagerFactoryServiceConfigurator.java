 ...
 * @author Paul Ferraro
 */
public class DistributableSessionManagerFactoryServiceConfigurator<C extends DistributableSessionManagementConfiguration<Module>> extends SimpleServiceNameProvider implements CapabilityServiceConfigurator, Function<org.wildfly.clustering.web.session.SessionManagerFactory<ServletContext, LocalSessionContext, Batch>, SessionManagerFactory> {
    ...
    public DistributableSessionManagerFactoryServiceConfigurator(ServiceName name, SessionManagerFactoryConfiguration configuration, DistributableSessionManagementProvider<C> provider, Immutability immutability) {
        ...
        ByteBufferMarshaller marshaller = provider.getSessionManagementConfiguration().getMarshallerFactory().apply(configuration.getModule());
        this.configurator = provider.getSessionManagerFactoryServiceConfigurator(new SessionManagerFactoryConfigurationAdapter(configuration, marshaller, immutability));
    }
