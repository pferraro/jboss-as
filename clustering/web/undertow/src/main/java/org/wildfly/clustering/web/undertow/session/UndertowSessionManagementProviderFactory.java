...
public class UndertowSessionManagementProviderFactory implements SessionManagementProviderFactory {
    ...
    private final LegacySessionManagementProviderFactory<DistributableSessionManagementConfiguration<Module>> legacyFactory;
    ...
    public SessionManagementProvider createSessionManagementProvider(DeploymentUnit unit, ReplicationConfig config) {
        DistributableSessionManagementProvider<DistributableSessionManagementConfiguration<Module>> provider = unit.getAttachment(DistributableSessionManagementProvider.ATTACHMENT_KEY);
